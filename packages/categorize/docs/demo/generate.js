const E234 = {
  ...
  "categoriesPerRow": 2,
  "rationale": "<p>Traditional equipment must be carried on board or shipped from Earth. 3D-printed equipment can be built on demand or rebuilt if it gets lost or broken.</p>",
