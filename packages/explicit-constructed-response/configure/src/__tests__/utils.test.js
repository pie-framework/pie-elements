...
describe('processMarkup', () => {
  ...
  assertProcessMarkup('<p>This is another test.</p>', '<p>This is another test.</p>');

  assertProcessMarkup('', '');

  assertProcessMarkup(undefined, '');

  assertProcessMarkup(null, '');

  assertProcessMarkup('<div> \\tfoo\\nbar </div>', '<div> foobar </div>', 'should remove \t, \n from the string');

  assertProcessMarkup('<div> "foobar" </div>', '<div> "foobar" </div>', 'should replace " with " in the string');
...
describe('createSlateMarkup', () => {
  ...
  assertCreateSlateMarkup('<p>This is another test.</p>', '<p>This is another test.</p>');

  assertCreateSlateMarkup('', '');

  assertCreateSlateMarkup(undefined, '');

  assertCreateSlateMarkup(null, '');

  assertCreateSlateMarkup('<div> \\tfoo\\nbar </div>', '<div> foobar </div>', 'should remove \t, \n from the string');

  assertCreateSlateMarkup('<div> "foobar" </div>', '<div> "foobar" </div>', 'should replace " with " in the string');
