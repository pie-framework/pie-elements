...
describe('Model Options', () => {
  ...
  it('render correctly: update model type to Pie', () => {
    ...
    expect(onChange).toBeCalledWith(expect.objectContaining({ modelTypeSelected: 'pie' }));
  })
  ...
  it('render correctly: update model type to Bar', () => {
    ...
    expect(onChange).toBeCalledWith(expect.objectContaining({ modelTypeSelected: 'bar' }));
  })
  ...
  it('render correctly: update max no of model', () => {
    ...
    expect(onChange).toBeCalledWith(expect.objectContaining({ maxModelSelected: 4 }));
  })
  ...
  it('render correctly: update parts per model', () => {
    ...
    expect(onChange).toBeCalledWith(expect.objectContaining({ partsPerModel: 7 }));
  })
  ...
  it('render correctly: update student config checkbox', () => {
    ...
    expect(onChange).toBeCalledWith(expect.objectContaining({ allowedStudentConfig: true }));
  })
