...
describe('createDefaultModel', () => {
    it('should create a default model with updated responses', () => {
        ...
        expect(result.responses).toEqual(expect.objectContaining({
            '1': expect.objectContaining( { allowTrailingZeros: undefined, alternates: {}, answer: "2", ignoreOrder: undefined, validation: undefined}),
            '2': expect.objectContaining( { allowTrailingZeros: undefined, alternates: {"1": "4"}, answer: "3", ignoreOrder: undefined, validation: undefined}),
        }));
    });
});
