...
export class Main extends React.Component {
  ...
  reloadTicksData = (domain, width, ticks) => {
    ...
    model.correctResponse.forEach((correctResp, key)  => {
      if (correctResp.domainPosition < domain.min || correctResp.domainPosition > domain.max 
      || (correctResp.size && (correctResp.domainPosition + correctResp.size < domain.min ||
  ...
  render() {
    ...
    const { contentDimensions = {}, instruction = {}, teacherInstructions = {},
      prompt = {}, mathMlOptions = {}, numberLineDimensions = {}, 
      maxMaxElements = undefined, hidePointConfigButtons = false,
      availableTools = ["PF"]} = configuration || {};
    ...
    return (
      ...
      <layout.ConfigLayout dimensions={contentDimensions} hideSettings={true} settings={null}>
        ...
        <div className={classes.flexRow}>
          {model.widthEnabled && (
              <Size size={graph} min={numberLineDimensions.min} max={numberLineDimensions.max} 
                    step={numberLineDimensions.step} onChange={this.changeSize} />
            )}
          <div></div>
          ...
          <React.Fragment>
            ...
            <div className={classes.pointTypeChooser}>
              <PointConfig onSelectionChange={this.availableTypesChange} selection={graph.availableTypes}
                availableTools={availableTools} hideButtons={hidePointConfigButtons}/>
            </div>
