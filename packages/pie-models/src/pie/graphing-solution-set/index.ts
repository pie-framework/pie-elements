 ...
 */
export interface GraphingSolutionSetPie extends PieModel {
  ...
  /** Indicates line information for GSS item type */
 ...
 * @additionalProperties false
 */
export interface GraphingSolutionSetConfigure extends PromptConfig, CommonConfigSettings {
  /**
