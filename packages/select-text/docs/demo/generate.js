...
exports.htmlSample2 = (id, element) => {
  return Object.assign({}, { id, element },     {
    highlightChoices: true,
    feedback: {
      correct: {
    ...
    <div style="color: blue">
        <p>Recently <span>I</span>'ve met <span>her</span>. <span>She</span> is extremely professional.</p>
    </div>`,
    prompt: "<p>Select all the texts that indicate a person</p>",
    maxSelections: 2,
    mode: 'sentence',
    tokens: [
      {
