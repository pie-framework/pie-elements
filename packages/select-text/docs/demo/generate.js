...
exports.model = (id, element) => {
  return Object.assign(
    ...
    base({
      ...
      tokens: [
        // {
        //   id: '0-30-1751440197593',
        //   quote: 'She thought about what she had',
        //   start: 0,
        //   end: 30,
        // },
        // {
        //   id: '185-206-1751440199435',
        //   quote: 'o please her Coach, y',
        //   start: 185,
        //   end: 206,
        // },
        // {
        //   id: '356-379-1751440202337',
        //   quote: 'e much more humorous to',
        //   start: 356,
        //   end: 379,
        // },
        // {
        //   id: '0-88-1751443110733',
        //   quote: 'She thought about what she had to do, struggling to rein in her wild, fearful thoughts. ',
        //   start: 0,
        //   end: 88,
        // },
        // {
        //   id: '590-607-1751443116013',
        //   quote: "Át last Ñatasha's",
        //   start: 590,
        //   end: 607,
        // },
        // {
        //   id: '624-641-1751443118643',
        //   quote: 'The faces of past',
        //   start: 624,
        //   end: 641,
        // },
        // {
        //   id: '1223-1231-1751443121777',
        //   quote: 'header 2',
        //   start: 1223,
        //   end: 1231,
        // },
        // {
        //   id: '358-376-1751443129379',
        //   quote: '»»» were much more',
        //   start: 358,
        //   end: 376,
        // },
        // {
        //   id: '137-154-1751443132310',
        //   quote: 'mind never scored',
        //   start: 137,
        //   end: 154,
        // },
      ],
      text: '<p>She thought about what she had to do, <u>struggling to rein</u> in her wild, <b>fearful thoughts</b>. Coach Cummings always said that an undisciplined mind <sup>never scored </sup>a perfect 10. Natasha  €€€ wanted to please her Coach, yet sometimes his approval wasn&#x27;t as exciting as his anger. The gymnasts were unanimous about one thing: Coach Cummings&#x27;s fits of disapproving rage »»» were much more humorous to witness than his infrequent, backslapping moments of high praise. Just for a hair of a moment, Natasha wondered if she really wanted a perfect 10, so weary was she of trying for but never achieving one</p><p><em>Át last Ñatasha&#x27;s moment arrived.</em> The <s>faces</s> of past giants of gymnastics swam before her mind&#x27;s eye, now razor–sharp with fierce determination. &quot;I am talented. I am not afraid. I will make a perfect 10,&quot; she spoke aloud to herself, as she approached the mat, dusted her hands with chalk to prevent slippage, and returned to her starting point. Suddenly, the din of the gymnasium was silent to her. Forcing all sound out of her mind, she focused on the gleaming balance beam ahead of her. Taking a deep breath, Natasha made her graceful, yet powerful approach, mounted the beam flawlessly, and...executed her first perfect 10.</p><p></p><table border="1"><tbody><tr><td><p>header 1</p></td><td><p>header 2</p></td></tr><tr><td><p>row </p></td><td><p>row</p></td></tr></tbody></table><div></div>',
      rubricEnabled: false,
    }),
  );
};
