...
module.exports = {
  ...
  libs: {
    ...
    packages: [
      { name: '@pie-lib/drag-module', version: '^2.8.9' },
      { name: '@pie-lib/math-rendering-module', version: '^2.8.0' },
      { name: '@pie-lib/math-edit-module', version: '^2.5.0' },
      { name: '@pie-lib/shared-module', version: '^1.14.9' },
      { name: '@pie-lib/editable-html-module', version: '^5.6.9' },
      { name: '@pie-lib/config-module', version: '^2.19.9' },
    ],
  },
};
