...
module.exports = {
  ...
  libs: {
    ...
    packages: [
      { name: '@pie-lib/drag-module', version: '^4.0.6' },
      { name: '@pie-lib/math-rendering-module', version: '^5.0.6' },
      { name: '@pie-lib/math-edit-module', version: '^4.2.1' },
      { name: '@pie-lib/shared-module', version: '^5.2.1' },
      { name: '@pie-lib/editable-html-module', version: '^7.1.3' },
      { name: '@pie-lib/config-module', version: '^4.0.6' },
    ],
  },
};
