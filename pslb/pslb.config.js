...
module.exports = {
  ...
  libs: {
    ...
    packages: [
      { name: '@pie-lib/drag-module', version: '^3.0.5' },
      { name: '@pie-lib/math-rendering-module', version: '^4.0.5' },
      { name: '@pie-lib/math-edit-module', version: '^3.0.5' },
      { name: '@pie-lib/shared-module', version: '^3.0.5' },
      { name: '@pie-lib/editable-html-module', version: '^6.0.5' },
      { name: '@pie-lib/config-module', version: '^3.0.0' },
    ],
  },
};
