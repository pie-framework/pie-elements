...
module.exports = {
  ...
  libs: {
    ...
    packages: [
      { name: '@pie-lib/drag-module', version: '^2.10.0' },
      { name: '@pie-lib/math-rendering-module', version: '^3.1.0' },
      { name: '@pie-lib/math-edit-module', version: '^2.8.0' },
      { name: '@pie-lib/shared-module', version: '^1.17.0' },
      { name: '@pie-lib/editable-html-module', version: '^5.9.0' },
      { name: '@pie-lib/config-module', version: '^2.22.0' },
    ],
  },
};
