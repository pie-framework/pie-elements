...
module.exports = {
  ...
  libs: {
    ...
    packages: [
      { name: '@pie-lib/drag-module', version: '^4.0.7' },
      { name: '@pie-lib/math-rendering-module', version: '^5.0.7' },
      { name: '@pie-lib/math-edit-module', version: '^4.2.2' },
      { name: '@pie-lib/shared-module', version: '^5.2.2' },
      { name: '@pie-lib/editable-html-module', version: '^7.1.4' },
      { name: '@pie-lib/config-module', version: '^4.0.7' },
    ],
  },
};
