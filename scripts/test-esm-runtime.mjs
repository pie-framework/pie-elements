...
// Test a sample of packages
const TEST_PACKAGES = [
  'multiple-choice',  // Common, has bare imports
  'categorize',       // Common, has bare imports
];
...
async function testPackage(pkgName) {
  const esmPath = join(packagesDir, pkgName, 'esm/element.js');
