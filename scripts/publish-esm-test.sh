...
echo "════════════════════════════════════════════════════════════"
echo "📦 Publishing @pie-element packages with 'esmbeta' dist-tag"
echo "════════════════════════════════════════════════════════════"
echo ""
...
#   - First time: 11.0.0 → 11.0.1-esmbeta.0
#   - Next time: 11.0.1-esmbeta.0 → 11.0.1-esmbeta.1
#   - Next time: 11.0.1-esmbeta.1 → 11.0.1-esmbeta.2
...
echo "  yarn add @pie-element/package-name@esmbeta"
echo ""
echo "To test on CDN:"
